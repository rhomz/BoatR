package com.da.bfar.apps.boatr.utils;
...
public class PagerSlidingTabStripNoViewPager extends HorizontalScrollView {
    ...
    private String TAG = PagerSlidingTabStripNoViewPager.class.getSimpleName();
...
//  private ViewPager pager;
    ...
    private PagerOnTabClickListener pagerCallback;
    ...
    public PagerSlidingTabStripNoViewPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabStripNoViewPager(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setTabViewTitle(ArrayList<String> tabtitle,PagerOnTabClickListener pagerCallback) {
...
//    pager.setOnPageChangeListener(pageListener);
    ...
    public void setResetGuide(int position){

        currentPosition -= position;
//        callback.onDefault(position,tabtitle.get(position));
//        invalidate();
    }

    public void setInvalidate(int currentPosition){
    ...
    public void setInViewMode(boolean isInViewMode) {
    ...
    public void notifyDataSetChanged() {
        ...
        tabCount = tabtitle.size();

        for (int i = 0; i < tabCount; i++) {
            addTextTab(i, tabtitle.get(i));
      /*if (tabtitle.get(i) instanceof IconTabProvider) {
    ...
    private void addTab(final int position, View tab) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                /*Log.e(TAG,"addTab:"+pager.getCurrentItem());
                pager.setCurrentItem(position);*/
//                invalidate();
//                currentPosition = position;
                pagerCallback.onTabClick(position,tabtitle.get(position));
            }
        });
    ...
    private void setConvas(Canvas canvas){
        this.canvas = canvas;
    }
...
//        scrollToChild(pager.getCurrentItem(), 0);
    ...
    public interface PagerOnTabClickListener {
        void onTabClick(int position, String title);
    }

    public interface PagerOnDefaultLoad{
        void onDefault(int position, String title);
    }
}
